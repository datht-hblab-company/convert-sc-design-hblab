...
test("resolveInstallPath returns global directories", () => {
  ...
  assert.equal(
    ...
    "/tmp/example-home/.claude/skills/convert-sc-design-hblab"
  );
  ...
  assert.equal(
    ...
    "/tmp/example-home/.cursor/skills/convert-sc-design-hblab"
  );
  ...
  assert.equal(
    ...
    "/tmp/example-home/.codex/skills/convert-sc-design-hblab"
  );
});
...
test("resolveInstallPath returns project-local directories", () => {
  ...
  assert.equal(
    ...
    "/tmp/project/.claude/skills/convert-sc-design-hblab"
  );
  ...
  assert.equal(
    ...
    "/tmp/project/.cursor/skills/convert-sc-design-hblab"
  );
  ...
  assert.equal(
    ...
    "/tmp/project/.codex/skills/convert-sc-design-hblab"
  );
  ...
  assert.equal(
    ...
    "/tmp/project/.agent/skills/convert-sc-design-hblab"
  );
});
...
test("resolveInstallPath prefers ~/.agent for antigravity global installs", () => {
  assert.equal(
    ...
    "/tmp/home/.agent/skills/convert-sc-design-hblab"
  );
});
...
test("resolveInstallPath can prefer ~/.gemini/antigravity/skills for antigravity", () => {
  assert.equal(
    ...
    "/tmp/home/.gemini/antigravity/skills/convert-sc-design-hblab"
  );
});
